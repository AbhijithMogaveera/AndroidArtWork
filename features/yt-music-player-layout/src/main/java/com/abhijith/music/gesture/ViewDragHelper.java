 ...
 *
 * @link <a href="https://android.googlesource.com/platform/frameworks/support/+/a9ac247af2afd4115c3eb6d16c05bc92737d6305/customview/src/main/java/androidx/customview/widget/ViewDragHelper.java">...</a>"
 */
public class ViewDragHelper {
    private static final String TAG = "ViewDragHelper"; //done

    /**
     * A null/invalid pointer ID.
     */
    public static final int INVALID_POINTER = -1; //done

    /**
     * A view is not currently being dragged or animating as a result of a fling/snap.
     */
    public static final int STATE_IDLE = 0; //done

    /**
     * A view is currently being dragged. The position is currently changing as a result
     * of user input or simulated user input.
     */
    public static final int STATE_DRAGGING = 1; //done

    /**
     * A view is currently settling into place as a result of a fling or
     * predefined non-interactive motion.
     */
    public static final int STATE_SETTLING = 2; //done
